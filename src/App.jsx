...
function App() {
  ...
  return (
    ...
    >
      <a href="https://github.com/riki-210/gemini-ai-chat" target="_blank" rel="noopener noreferrer">
        <h1 className="text-4xl font-bold text-blue-500 mb-4 animate-bounce">Gemini Chat</h1>
      </a>
      <textarea
        required
